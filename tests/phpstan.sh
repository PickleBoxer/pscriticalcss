...
docker exec -tid temp-ps rm -rf /var/www/html/modules/pscriticalcss
...
docker run --rm --volumes-from temp-ps \
       -v $PWD:/var/www/html/modules/pscriticalcss \
       -e _PS_ROOT_DIR_=/var/www/html \
       --workdir=/var/www/html/modules/pscriticalcss phpstan/phpstan:0.12 \
       analyse \
       --configuration=/var/www/html/modules/pscriticalcss/tests/phpstan/phpstan-$PS_VERSION.neon
